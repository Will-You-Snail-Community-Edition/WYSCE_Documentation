...
&nbsp;  
# Description  
Returns a FLAG tool property (a multiple checkbox UI such as the "what triggers a trigger" properties) to be added to an editor object in leveleditor_database_ini or modhelper_predatabase_override_me 
&nbsp;  
# Arguments
### key
