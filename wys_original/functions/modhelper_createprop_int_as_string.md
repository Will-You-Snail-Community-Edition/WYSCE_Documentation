...
&nbsp;  
# Description  
Returns an integer-based tool property (that shows up in-game as a slider that picks between strings) to be added to an editor object in leveleditor_database_ini or modhelper_predatabase_override_me 
&nbsp;  
# Arguments
### key
...
&nbsp;    
### array_loca_values
The id of the NAMES OF THE INDIVIDUAL OPTIONS/CHECKBOXES of the property in the localization spreadsheet. In Community Edition putting a string that ISN'T a localization ID will treat the id AS the string. In vanilla it returns an "invalid loca string" variant.
&nbsp;    
